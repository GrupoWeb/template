...
class MenusTableSeeder extends Seeder
{
    ...
    */
    ...
    public function run()
    {
        ...
        /* guest menu */
        $this->insertLink('user,admin,legal', 'Dashboard', '/', 'cil-speedometer');
        ...
        $this->endDropdown();
        $this->insertTitle('user,admin,legal', 'Legal');
        $this->insertLink('user,admin,legal', 'Expediente', '/documents', 'cil-clipboard');
