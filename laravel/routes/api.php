...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    */
    ...
    Route::post('getInfoByCode', 'LegalController@getInfoByCode');
    Route::get('getUserLegal', 'LegalController@getUserLegal');
    Route::get('getUserRole','LegalController@getUserRole');
